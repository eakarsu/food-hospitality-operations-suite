...
PORT="${PORT:-4010}"
DB_NAME="${PGDATABASE:-food_hospitality_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Food Hospitality Operations Suite"
echo "======================================="
echo
...
echo "Starting food hospitality operations suite frontend on http://localhost:$PORT"
echo "Login: admin@food-hospitality.local / admin123"
