...
const featureSeeds = [
  ['locations', 'Locations', 'Locations operating queue', 'Operations Lead', 'Review and assign next action'],
  ['menus', 'Menus', 'Menus operating queue', 'Operations Lead', 'Review and assign next action'],
  ['orders', 'Orders', 'Orders operating queue', 'Operations Lead', 'Review and assign next action'],
  ['reservations', 'Reservations', 'Reservations operating queue', 'Operations Lead', 'Review and assign next action'],
  ['kitchen', 'Kitchen', 'Kitchen operating queue', 'Operations Lead', 'Review and assign next action'],
  ['inventory', 'Inventory', 'Inventory operating queue', 'Operations Lead', 'Review and assign next action'],
  ['staffing', 'Staffing', 'Staffing operating queue', 'Operations Lead', 'Review and assign next action'],
  ['vendors', 'Vendors', 'Vendors operating queue', 'Operations Lead', 'Review and assign next action'],
  ['catering', 'Catering', 'Catering operating queue', 'Governance Lead', 'Review and assign next action'],
  ['revenue', 'Revenue', 'Revenue operating queue', 'Governance Lead', 'Review and assign next action'],
  ['reviews', 'Reviews', 'Reviews operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
  ['reports', 'Reports', 'Reports operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
  ["recipe-builder","Recipe Builder","Recipe Builder workspace","Recipe Menu Planning","Review source evidence and assign owner"],
  ["menu-digitization","Menu Digitization","Menu Digitization workspace","Recipe Menu Planning","Confirm findings, next action, and audit evidence"],
  ["food-costing","Food Costing","Food Costing workspace","Recipe Menu Planning","Confirm findings, next action, and audit evidence"],
  ["nutrition-allergen-review","Nutrition & Allergen Review","Nutrition & Allergen Review workspace","Recipe Menu Planning","Confirm findings, next action, and audit evidence"],
