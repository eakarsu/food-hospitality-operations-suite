export const AUTH_COOKIE = 'food_hospitality_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@food-hospitality.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@food-hospitality.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@food-hospitality.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
