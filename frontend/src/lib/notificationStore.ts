...
const seed: NotificationItem[] = [
  { id: 'note-1', title: 'Locations alert', detail: 'Locations queue needs review.', read: false },
  { id: 'note-2', title: 'Menus approval due', detail: 'Menus exception list needs approval.', read: false },
  { id: 'note-3', title: 'Orders updated', detail: 'Orders operating queue was refreshed.', read: true },
];
