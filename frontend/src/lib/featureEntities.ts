...
const entitySeeds = [
  ...
  ["recipe-builder","Recipe Builder Records","Recipe Builder operating queue","Open","Recipe Builder follow-up list","Recipe Menu Planning","$0"],
  ["menu-digitization","Menu Digitization Records","Menu Digitization operating queue","Review","Menu Digitization follow-up list","Recipe Menu Planning","$0"],
  ["food-costing","Food Costing Records","Food Costing operating queue","Review","Food Costing follow-up list","Recipe Menu Planning","$0"],
  ["nutrition-allergen-review","Nutrition & Allergen Review Records","Nutrition & Allergen Review operating queue","Review","Nutrition & Allergen Review follow-up list","Recipe Menu Planning","$0"],
