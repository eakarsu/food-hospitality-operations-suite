...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Locations Packet', type: 'Locations', owner: 'Operations Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Menus Review Bundle', type: 'Menus', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Orders Evidence Set', type: 'Orders', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
