...
const features = [
  ...
  },
  {
    ...
    icon: Workflow,
    summary: "Ingredients, instructions, portions, prep timing, substitutions, and kitchen notes.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Recipe Builder", value: "32", note: 'Active items' },
  ...
  },
  {
    ...
    href: "/menu-digitization",
    category: "Recipe Menu Planning",
    icon: Workflow,
    summary: "Menu photos, extracted items, categories, prices, descriptions, and cleanup queue.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Menu Digitization", value: "40", note: 'Active items' },
  ...
  },
  {
    ...
    category: "Recipe Menu Planning",
    icon: Workflow,
    summary: "Ingredient costs, portion margins, vendor changes, and menu profitability.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Food Costing", value: "48", note: 'Active items' },
      { label: 'Exceptions', value: "5", note: 'Need review' },
      { label: 'Due Soon', value: "8", note: 'Next 14 days' },
    ],
  },
  {
    slug: "nutrition-allergen-review",
    title: "Nutrition & Allergen Review",
    href: "/nutrition-allergen-review",
    category: "Recipe Menu Planning",
    icon: Workflow,
    summary: "Nutrition estimates, allergen flags, dietary tags, and compliance notes.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Nutrition & Allergen Review", value: "56", note: 'Active items' },
...
export const featureFamilies = [
  ...
  { name: "Recipe Menu Planning", features: ["Recipe Builder","Menu Digitization","Food Costing","Nutrition & Allergen Review"] },
