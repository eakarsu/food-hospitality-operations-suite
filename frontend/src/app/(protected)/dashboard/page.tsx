...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Food Hospitality Operations Dashboard"
      subtitle="One merged food hospitality operations view for Locations, Menus, Orders, Reservations, Kitchen, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared food hospitality operations jobs into one surface. Locations, Menus, Orders, Reservations, Kitchen, Inventory, documents, audit, and AI are presented as platform features.</div>
